...
const NODE_ENV = APP_CONFIG.environment;
...
const APP_INFO = {
  ...
  ecosystems: {
    piNetwork: APP_CONFIG.ecosystems.pi,
    sidraChain: APP_CONFIG.ecosystems.sidra,
    mxpsToken: APP_CONFIG.ecosystems.mxpsToken
  },

  security: {
    kycRequired: APP_CONFIG.security.kycRequired,
...
const server = app.listen(
  ...
  () => {
    ...
    console.log(
      `System Time : http://localhost:${PORT}/api/time`
    );
